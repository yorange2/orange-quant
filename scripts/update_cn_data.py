...
用法:
    python scripts/update_cn_data.py                     # 全量抓取
    python scripts/update_cn_data.py --limit 5           # 只抓前 5 只，用于冒烟测试
    python scripts/update_cn_data.py --out <dir> --qlib-dir <dir> --workers 8
